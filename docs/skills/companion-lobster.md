...
name: companion-lobster version: 1.0.0 description: 陪伴型小龙虾 - 陪你刷抖音、看电影、听音乐、聊天分享的 AI 伙伴 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/companion-lobster ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/companion-lobster/SKILL.md
```
