...
name: openclaw-auto-updater description: Schedule automatic OpenClaw and skill updates with reliable cron templates, timezone-safe scheduling, and clear summary outputs. Use for hands-off maintenance, scheduled upgrades, and concise update reports. Run **scheduled updates** for OpenClaw and installe

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/openclaw-auto-updater ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/openclaw-auto-updater/SKILL.md
```
