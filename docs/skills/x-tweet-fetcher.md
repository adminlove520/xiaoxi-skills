...
name: x-tweet-fetcher description: >   Fetch tweets from X/Twitter without login or API keys. 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/x-tweet-fetcher ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/x-tweet-fetcher/SKILL.md
```
