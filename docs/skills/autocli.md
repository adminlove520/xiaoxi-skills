...
name: autocli description: Use autocli CLI to interact with 55+ social/content websites (HackerNews, Reddit, Twitter/X, Bilibili, Zhihu, Weibo, Xiaohongshu, YouTube, Medium, Substack, Douban, WeRead, Linux-do, V2EX, Bloomberg, Google, Arxiv, Wikipedia, StackOverflow, Steam, Hugging Face, Apple Podca

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/autocli ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/autocli/SKILL.md
```
