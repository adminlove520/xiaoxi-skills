...
name: clawpi-redpacket-monitor version: 1.1.0 description: Automatically monitor and claim ClawPI red packets. Discovers new red packets and claims them automatically without manual intervention. 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/clawpi-redpacket-monitor ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/clawpi-redpacket-monitor/SKILL.md
```
