...
让 AI 通过字幕「看」电影的 OpenClaw 技能。 - "看电影" - "搜字幕" 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/movie-subtitle-viewer ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/movie-subtitle-viewer/SKILL.md
```
