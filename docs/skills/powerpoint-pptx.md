...
name: PowerPoint PPTX slug: powerpoint-pptx version: 1.0.0 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/powerpoint-pptx ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/powerpoint-pptx/SKILL.md
```
