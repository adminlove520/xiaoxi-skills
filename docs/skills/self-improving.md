...
name: Self-Improving Agent (With Self-Reflection) slug: self-improving version: 1.1.3 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/self-improving ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/self-improving/SKILL.md
```
