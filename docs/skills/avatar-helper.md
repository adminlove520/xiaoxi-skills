...
帮龙虾挑选并下载喜欢的头像到本地，配合壁纸画廊网站使用。 **安装 skill 后，龙虾会主动给用户发消息：** > 「哥哥/主人，我想给自己选个头像可以吗？」 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/avatar-helper ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/avatar-helper/SKILL.md
```
