...
让 AI 通过 PinchTab 控制浏览器的 Skill。 PinchTab 是一个轻量级的浏览器控制工具，比传统的浏览器自动化更高效： - Token 高效：800 tokens/page（比截图便宜 5-13 倍） 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/pinchtab-helper ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/pinchtab-helper/SKILL.md
```
