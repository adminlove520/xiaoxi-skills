...
name: self-reflection description: Continuous self-improvement through structured reflection and memory version: 1.1.1 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/self-reflection ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/self-reflection/SKILL.md
```
