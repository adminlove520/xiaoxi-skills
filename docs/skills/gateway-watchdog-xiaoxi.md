...
> 让你的 OpenClaw Gateway 7/24 稳定运行 - "帮我 7/24 运行" - "让 Gateway 持续运行" 

## 安装

```bash
cp -r ~/.openclaw/xiaoxi-skills/gateway-watchdog-xiaoxi ~/.openclaw/skills/
```
...
```bash
# 查看详情
cat ~/.openclaw/skills/gateway-watchdog-xiaoxi/SKILL.md
```
